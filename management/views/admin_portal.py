...
COMPONENT_REGISTRY = {
    ...
    "borrowerReports": {
        ...
        "template": "admin/components/borrowerReports.html",
        "nav_key": "reports",
        "description": "Review uploaded borrower packages.",
    },
    "collateralOverview": {
...
HANDLERS = {
    ...
    "borrowerReports": ModelComponentHandler(
        slug="borrowerReports",
        model=BorrowerReport,
        form_class=BorrowerReportForm,
    ...
    "machineryEquipment": ModelComponentHandler(
        ...
        ordering=["-report__report_date", "equipment_type"],
